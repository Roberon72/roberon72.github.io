...
Please report this to https://github.com/markedjs/marked.`,n){let r="<p>An error occurred:</p><pre>"+$n(e.message+"",!0)+"</pre>";return t?Promise.resolve(r):r}if(t)return Promise.reject(e);throw e}}},Ui=new wR;function be(n,t){return Ui.parse(n,t)}be.options=be.setOptions=function(n){return Ui.setOptions(n),be.defaults=Ui.defaults,pD(be.defaults),be};be.getDefaults=Np;be.defaults=$i;be.use=function(...n){return Ui.use(...n),be.defaults=Ui.defaults,pD(be.defaults),be};be.walkTokens=function(n,t){return Ui.walkTokens(n,t)};be.parseInline=Ui.parseInline;be.Parser=kn;be.parser=kn.parse;be.Renderer=Od;be.TextRenderer=zp;be.Lexer=En;be.lexer=En.lex;be.Tokenizer=Rd;be.Hooks=ya;be.parse=be;var UY=be.options,$Y=be.setOptions,GY=be.use,WY=be.walkTokens,qY=be.parseInline;var YY=kn.parse,ZY=En.lex;var Fd=class n{SPOILER_PATTERN=/\|\|(.+?)\|\|/g;parseMarkdownDocument(t){let e=this.mergeUnclosedHtmlBlocks([...be.lexer(t)]),r=[],i="";for(let o of e)switch(o.type){case"heading":{let s=o;i=s.text;let a=s.raw.replace(/^#{1,6}\s+/,"");r.push({type:"heading",level:s.depth,html:be.parseInline(a),plainText:s.text});break}case"html":{r.push({type:"inline-html",html:o.raw});break}case"list":{let a=o.items.map((c,l)=>{let d=this.getRawText(c);return this.parseListItem(d,i,l)});r.push({type:"list",items:a});break}case"paragraph":{let s=o;r.push({type:"paragraph",html:be.parseInline(s.raw)});break}case"hr":case"thematic_break":{r.push({type:"thematic-break"});break}default:break}return r}mergeUnclosedHtmlBlocks(t){let e=[],r=0;for(;r<t.length;){let i=t[r];if(i.type==="html"&&this.countDivDepth(i.raw)>0){let o=i.raw,s=this.countDivDepth(i.raw);for(r++;r<t.length&&s>0;){let a=t[r];o+=this.tokenToHtml(a),s+=this.countDivDepth(a.raw??""),r++}e.push({type:"html",raw:o,pre:!1,text:o})}else e.push(i),r++}return e}tokenToHtml(t){switch(t.type){case"heading":{let e=t;return`<h${e.depth}>${be.parseInline(e.text)}</h${e.depth}>
`}case"paragraph":{let e=t;return`<p>${be.parseInline(e.text)}</p>
`}default:return t.raw??""}}countDivDepth(t){let e=(t.match(/<div\b[^>]*>/gi)??[]).length,r=(t.match(/<\/div>/gi)??[]).length;return e-r}getRawText(t){return t.tokens?t.tokens.map(e=>e.raw).join(""):t.raw||""}parseListItem(t,e,r){let i=[],o=t.matchAll(this.SPOILER_PATTERN);for(let c of o)i.push(c[1].replaceAll("`","").trim());let s=t.replace(this.SPOILER_PATTERN,"").trim();return s=s.replace(/\s+/g," ").trim(),{id:this.listItemId(e,s,r),text:s,spoilers:i}}listItemId(t,e,r){return`li-${this.hash(`${t}||${e}||${r}`)}`}hash(t){let e=5381;for(let r=0;r<t.length;r++)e=(e<<5)+e+t.charCodeAt(r),e=e&e;return Math.abs(e).toString(36).padStart(6,"0")}static \u0275fac=function(e){return new(e||n)};static \u0275prov=C({token:n,factory:n.\u0275fac,providedIn:"root"})};var Up=(()=>{class n{get vertical(){return this._vertical}set vertical(e){this._vertical=ta(e)}_vertical=!1;get inset(){return this._inset}set inset(e){this._inset=ta(e)}_inset=!1;static \u0275fac=function(r){return new(r||n)};static \u0275cmp=q({type:n,selectors:[["mat-divider"]],hostAttrs:["role","separator",1,"mat-divider"],hostVars:7,hostBindings:function(r,i){r&2&&(ue("aria-orientation",i.vertical?"vertical":"horizontal"),Q("mat-divider-vertical",i.vertical)("mat-divider-horizontal",!i.vertical)("mat-divider-inset",i.inset))},inputs:{vertical:"vertical",inset:"inset"},decls:0,vars:0,template:function(r,i){},styles:[`.mat-divider {
  display: block;
  margin: 0;
